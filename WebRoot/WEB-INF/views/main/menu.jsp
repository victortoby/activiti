...
<ul id="css3menu">
	...
	<li>
		<a rel="#">请假（普通表单）</a>
		<ul>
			<%-- <li><a href="${ctx }/oa/leave/apply">请假申请(普通)</a></li> --%>
	...
	<li>
		<a rel="#">办公用品申请</a>
		<ul>
 			<li><a rel="oa/bangong/apply">办公用品申请(普通)</a></li> 
			<li><a rel="oa/bangong/list/task">办公用品办理(普通)</a></li>
		</ul>
	</li>
	<li>
		<a rel="#">流程模版</a>
		<ul>
 			<li><a rel="workflow/deployList">模版列表</a></li> 
		</ul>
	</li>
	<!-- <li>
		<a rel="#">动态表单</a>
